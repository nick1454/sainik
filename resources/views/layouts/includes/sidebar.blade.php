...
<nav class="sidebar" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#test" aria-expanded="false" aria-controls="error">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#student" aria-expanded="false" aria-controls="error">
        <i class="icon-paper menu-icon"></i>
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#report" aria-expanded="false" aria-controls="error">
        <i class="icon-paper menu-icon"></i>
